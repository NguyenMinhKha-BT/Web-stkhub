					...
					<div class="row">
						<div class="col-md-12">
							...
							<?php
							   ...
							   $result = mysqli_query($conn, 'select count(ID) as total from sanpham where Malinhkien = '.$malinhkien );
							   ...
							   $result = mysqli_query($conn, "SELECT * FROM sanpham where Malinhkien = '$malinhkien' LIMIT $start, $limit " );
...
?>
			...
			if($i != $current_page){
			 ?>	
			 	  <li><?php echo '<a href="category.php?malinhkien='.$malinhkien.'&page='.$i.'">'.$i.'</a> '; ?></li>
			 <?php
			}
			  ?>	
						  <?php 
