					...
					<div class="col-md-9">
						<div class="caption">
							...
							<?php
								 ...
								 {                                      
								?>
								<div class="price"><?php  echo $s["giakhuyenmai"]?>0.000 VNĐ</div>
								<?php 
								}
								?>
								<?php
								 ...
								 {
								?>
								<div class="price"><?php  echo $s["Gia"]?>0.000 VNĐ</div>
								<?php 
								}
								?>
							...
							<?php
							    ...
							    echo  $_SESSION['cart'][$s["ID"]] * $s["giakhuyenmai"]?>0.000  </label> 
								<?php 
								}
								?>
								<?php
								...
								?>
									<label style="color:red">Thành tiền: <?php ;
							    echo  $_SESSION['cart'][$s["ID"]] * $s["Gia"]?>0.000  </label> 
								<?php 
								}
								?>
