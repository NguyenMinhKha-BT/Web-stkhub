...
?>
   ...
   $id = $_GET["id"];
   $query="SELECT s.ID,s.Ten,s.date,s.Gia,s.HinhAnh,s.thuonghieu,s.KhuyenMai,s.giakhuyenmai,s.Mota, n.Ten as linhkiens,s.Malinhkien
   from sanpham s 
                ...
                <form class="form-horizontal"  method="POST" action="<?php include 'xulusuasp.php'?>" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="thuonghieu" value="<?php echo $row["thuonghieu"] ?>" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">Linh kiện máy tính</label>
                    <div class="col-sm-10">
                    <select class="form-control select2" style="width: 100%;" name="malinhkien">
                    <option selected="selected" value="<?php echo $row["Malinhkien"] ?>"><?php echo $row["Tenlinhkien"] ?></option>

                      <?php
                         require '../inc/myconnect.php';
                         $sqls="SELECT ID,Ten from linhkien where ID !=".$row["Malinhkien"] ;
