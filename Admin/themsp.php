                ...
                <form class="form-horizontal" method="POST" action="<?php include 'xulyluasp.php' ?>" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control"  name="thuonghieu" placeholder="Thương hiệu" required>
                      </div>
                    </div>
                    ...
                    <option selected="selected" value="3">Chọn linh kiện máy tính</option>
                     <?php
                         require '../inc/myconnect.php';
                         $sql="SELECT ID,Ten from linhkien where ID != 3";
