                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
                         ...
                         $sql="SELECT s.ID,s.Ten,s.date,s.Gia,s.HinhAnh,s.thuonghieu,s.KhuyenMai,s.Mota, n.Ten as Tenlinhkien
                         from sanpham s 
                         LEFT JOIN linhkien n on n.ID = s.Malinhkien  ORDER BY s.Ten  ";
