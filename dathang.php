  ...
  <form name="form6" id="ff6" method="POST" action="<?php include 'luudonhang.php'?>">
	<div id="page-content" class="single-page">
		...
		<div class="col-lg-6">
			...
			<label>Dịch vụ</label>
                    <select class="form-control select2" multiple="multiple" name="dichvu" id="dichvu" onchange ="laygiatheoiddichvu(this.value)"  data-placeholder="Chọn dịch vụ" required>
										<?php
  ...
  <table class="table">
	...
	<?php
			if(isset($_SESSION['cart']))
			{
				...
				// echo $item;
				$str= implode(",",$item);
			    $query = "SELECT s.ID,s.Ten,s.date,s.Gia,s.HinhAnh,s.KhuyenMai,s.giakhuyenmai,s.Mota, n.Ten as Tenlinhkien,s.Malinhkien
				from sanpham s 
				...
				<div class="product well">
					...
					<div class="col-md-9">
						<div class="caption">
							...
							<div class="info">	
								<ul>
									<li>Thương hiệu: <?php  echo $s["thuonghieu"]?></li>
									<li>Linh kiện máy tính: <?php  echo $s["Tenlinhkien"]?></li>
								</ul>
							</div>
							<?php
							if($s["KhuyenMai"] == true)
